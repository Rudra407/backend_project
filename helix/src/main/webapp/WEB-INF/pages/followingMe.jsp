...
<html lang="en" class=""><head>
      ...
      <link rel="stylesheet" crossorigin="anonymous" href="http://gc.kis.v2.scr.kaspersky-labs.com/E3E8934C-235A-4B0E-825A-35A08381A191/abn/main.css?attr=aHR0cDovL2xvY2FsaG9zdDo4MDgwL3VpdGVzdA"><script src="https://code.jquery.com/jquery-3.5.0.min.js" integrity="sha256-xNzN2a4ltkB44Mc/Jz3pT4iU1cmeR0FkXs4pru/JxaQ=" crossorigin="anonymous"></script>
                  ...
                  <div class="layout_content">
                     <div class="feed">
                        <div class="feed_header">
                           <h1 class="feed_title">Following Me :)</h1>
                        </div>


                        <c:forEach var="member" items="${FOLLOWINGME}">
                                    ...
                                    <div class="joke_wrapper">
                                        <div class="joke_block joke_block--header">
                                            ...
                                            <span class="joke_element joke_element--author-username">${member.email}</span>
                                                <div class="joke_element joke_element--author-img"><img src="/static/images/default-user.jpg">
                                                </div>
                                            </div>
                                        <button class="follow-member" type="submit" member-id="${member.id}" tabindex = "0" style="margin-top: 12px;" >
