...
public class MainController extends BaseController {
    ...
    public @ResponseBody String signUpData(@RequestBody Member member, HttpServletResponse response, HttpServletRequest request) {
    ...
    public @ResponseBody
    String getWikiResultGson(ModelMap modelMap, @RequestParam("country") String country, HttpServletResponse response, HttpServletRequest request) {
